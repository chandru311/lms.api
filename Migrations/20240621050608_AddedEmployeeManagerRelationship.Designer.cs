...
namespace lms.api.Migrations
{
    ...
    [Migration("20240621050608_AddedEmployeeManagerRelationship")]
    partial class AddedEmployeeManagerRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lms.api.Models.Employees", b =>
                {
                    b.HasOne("lms.api.Models.Employees", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("lms.api.Models.Managers", "Manager")
                        .WithMany()
